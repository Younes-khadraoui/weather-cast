...
export default async function Home() {
  ...
  return (
    <div className="grid gap-4">
      <div className="bg-[#1E1E1E] rounded-lg mx-10 p-6">
      ...
      {/* Todays Highlights */}
      <div className="bg-[#1E1E1E] rounded-lg mx-10 ">
        ...
        <div className="flex">
          <div className="bg-[#272727] m-4 p-4 rounded-lg flex-grow">
            ...
            <div className="flex items-center gap-4">
              <Droplets size={45} />
              <p className="text-3xl font-semibold">{data.current.humidity}%</p>
            </div>
          </div>
          <div className="bg-[#272727] m-4 p-4 rounded-lg flex-grow">
      ...
      <div className="mx-10 ">
        ...
        <div className="grid grid-cols-2 gap-4">
          {data.forecast.forecastday[0].hour.slice(0, 6).map((hour, index) => (
            <div
              className="bg-[#1E1E1E] rounded-lg mb-4 p-2 grid justify-center items-center"
              key={index}
            >
      ...
      <div className="bg-[#1E1E1E] rounded-lg mx-10">
        <h2 className="text-xl p-4 font-bold">5 days forecast</h2>
      </div>
    </div>
  );
}
